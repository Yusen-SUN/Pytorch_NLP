...
class EncoderRNN(nn.Module):
    ...
    def forward(self, input_seq, input_lengths, h=None, c=None):
        ...
        c = c.view(self.num_layer, 2, batch_size, self.hidden_dim).contiguous()[-1:,:,:,:].transpose(0, 1).view(1, batch_size, 2*self.hidden_dim).contiguous()
        #print('h', h.size())
        #rint('c', c.size())
